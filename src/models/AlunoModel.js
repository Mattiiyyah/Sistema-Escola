...
class Aluno {
    ...
    valida() {
        ...
        if (!this.body.nomeResponsavel || this.body.nomeResponsavel.trim().length === 0) this.errors.push('Adicione o nome do responsável');

        if (!/^[A-Za-zÀ-ÿ\s]+$/.test(this.body.nomeResponsavel)) this.errors.push('Nome do responsável só pode conter letras');
        ...
        if (this.body.pago !== 'true' && this.body.pago !== 'false') this.errors.push('Selecione o status de pagamento');
    }
